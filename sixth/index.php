            ...
            <?php 
                $users = [
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-b.png",
                    ...
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-c.png",
                    ...
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-e.png",
                        "phone" => "+1 313-779-1347",
                        "mail" => "john.cook@smartadminwebapp.com",
                        "location" => "55 Smyth Rd, Detroit, MI, 48341, USA",
                        "facebook" => "",
                        "X" => "",
                        "Linkedin" => ""
                    ],
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-k.png",
                        "phone" => "+1 313-779-3314",
                        "mail" => "jim.ketty@smartadminwebapp.com",
                        "location" => "134 Tasy Rd, Detroit, MI, 48212, USA",
                        "facebook" => "",
                        "X" => "",
                        "Linkedin" => ""
                    ],
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-g.png",
                        "phone" => "+1 313-779-8134",
                        "mail" => "john.oliver@smartadminwebapp.com",
                        "location" => "134 Gallery St, Detroit, MI, 46214, USA",
                        "facebook" => "",
                        "X" => "",
                        "Linkedin" => ""
                    ],
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-h.png",
                        "phone" => "+1 313-779-7613",
                        "mail" => "sarah.mcbrook@smartadminwebapp.com",
                        "location" => "13 Jamie Rd, Detroit, MI, 48313, USA",
                        "facebook" => "",
                        "X" => "",
                        "Linkedin" => ""
                    ],
                    [
                        ...
                        "imglink" => "img/demo/avatars/avatar-i.png",
                    ...
                    [
                        "name" => "Arica Grace",
                        "profession" => "Accounting, Gotbootstrap Inc.",
                        "imglink" => "img/demo/avatars/avatar-j.png",
                        "phone" => "+1 313-779-3347",
                        "mail" => "arica.grace@smartadminwebapp.com",
                        "location" => "798 Smyth Rd, Detroit, MI, 48341, USA",
                        "facebook" => "",
                        "X" => "",
                        "Linkedin" => ""
                    ],
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-success mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?php echo $user["imglink"]; ?>'); background-size: cover;"></span>
                                </span>
